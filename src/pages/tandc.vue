<template>
    <div class="m-5 wrapper">
        <div class="mb-3">
            The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to PHOENIX GLOBAL INFOTECH and
        ...
        <div class="mb-3"> 
            ...
            <div class="mb-3">
                ...
                products or services. Violations of system or network security may result in civil or criminal
                liability. The business and / or its associate entities will have the right to investigate occurrences
                that they suspect as involving such violations and will have the right to involve, and cooperate with,
                ...
                www.phnxglobal.com or their breach of the terms .
            </div>
            <div class="mb-3">
                <h2>LIABILITY</h2>
                ...
                suspension or/and termination was justified or not, negligent or intentional, inadvertent or advertent.
                ...
                User for all damages or/and losses or/and causes of action exceed the amount paid by the User to
            ...
            <div class="mb-3">
                ...
                limitations, incidental and consequential damages, lost profits, or damage to computer hardware or loss
                of data information or business interruption) resulting from the use or inability to use the Website and
                the Website material, whether based on warranty, contract, tort, or any other legal theory, and whether
